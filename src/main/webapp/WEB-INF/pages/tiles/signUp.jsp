...
<div class="register">
    ...
    <form method="#" action="#" class="form-horizontal">
        ...
        <div class="control-group">
            <label class="control-label" for="inputCompanyID">Company Id:</label>
        ...
        <div class="control-group">
            <label class="control-label" for="inputConPass">Newslatter: <span
                    class="text-error">*</span></label>
        ...
        <div class="control-group">
            <div class="controls">
                <label class="checkbox">
                    <input type="checkbox"> I'v read and agreed on <a href="#">Terms &amp; Condations</a>
                </label>
                <br>
