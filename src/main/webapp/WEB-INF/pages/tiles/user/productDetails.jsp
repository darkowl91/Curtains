                ...
                <div class="product-inputs">
                    <form method="#" action="#">
                        ...
                        <div class="input-append">
                            ...
                            <button class="btn" rel="tooltip" data-title="+To Wishlist"><i class="icon-heart"></i>
                            </button>

                            <button class="btn" rel="tooltip" data-title="+To Compare"><i class="icon-refresh"></i>
                            </button>
                        </div>
...
<div class="product-tab">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="descraption">
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer a eros neque. In sapien est, malesuada
                non interdum id, cursus vel neque. Curabitur quis sem vel justo dictum ullamcorper ac vehicula lacus.
                Duis nisi dolor, suscipit id adipiscing ac, vestibulum in magna. Vestibulum ante ipsum primis in
                faucibus orci luctus et ultrices posuere cubilia Curae; Fusce ut metus sem. Etiam in odio eu metus
                ornare convallis in sit amet lorem.

                Suspendisse potenti. In non nisl sem, eu rutrum augue. Donec eu dolor vel massa ornare cursus id eget
                erat. Mauris in ante magna. Curabitur eget risus mi, non interdum lacus. Duis magna leo, rhoncus eget
                malesuada quis, semper a quam. Morbi imperdiet imperdiet lectus ac pellentesque. Integer diam sem,
                vulputate in feugiat ut, porttitor eu libero. Integer non dolor ipsum. Cras condimentum mattis turpis
                quis vestibulum. Nulla a augue ipsum. Donec aliquam velit vel metus fermentum dictum sodales metus
                condimentum. Nullam id massa quis nulla molestie ultrices eget sed nulla. Cras feugiat odio at tellus
                euismod lacinia.
            </p>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="btn-group" data-toggle="buttons-radio">
                            <button type="button" class="btn" rel="tooltip" data-title="1/5"><i class="icon-star"></i>
                            </button>
                            <button type="button" class="btn" rel="tooltip" data-title="2/5"><i class="icon-star"></i>
                            </button>
                            <button type="button" class="btn" rel="tooltip" data-title="3/5"><i class="icon-star"></i>
                            </button>
                            <button type="button" class="btn" rel="tooltip" data-title="4/5"><i class="icon-star"></i>
                            </button>
                            <button type="button" class="btn" rel="tooltip" data-title="5/5"><i class="icon-star"></i>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <li class="span3 clearfix">
                ...
                <div class="thumbSetting">
                    ...
                    <div class="thumbButtons">
                        <button class="btn btn-primary btn-small" data-title="+To Cart" data-placement="top"
                                rel="tooltip">
